...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        String test = apiClient.getUserBodyByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        // 注入的apiClient对象是读取这个本地密钥的对象，没用到当前登录对象的密钥，因此需要new一个apiclient
        // String usernameByPost = apiClient.getUserBodyByPost(user);
        ApiClient tempApiClient = new ApiClient(accesskey,secretKey);
        String response = null;
        if(interfaceInfo.getId() == 1){
            response = tempApiClient.getUserBodyByPost(user);
        }else if(interfaceInfo.getId() == 2){
            response = tempApiClient.getUserSexByPost(user);
        }
